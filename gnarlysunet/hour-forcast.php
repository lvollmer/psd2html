...
<div class="container">
    <div class="row">
        <div class="col-lg-12 hour-forcast-header text-center">
            <img width="690" height="90" src="images/add.gif" alt=" " class="img-responsive">
        </div>
    </div>
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hour-forcast-left">
            <div class="max-width">
                ...
                <div class="twitter">
                    <img src="images/twitter-widget.png" class="img-responsive" alt=""/>
                </div>
