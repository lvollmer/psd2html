...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var m=p&&p.scroller_images_width?p.scroller_images_width:"189";
        var n=p&&p.scroller_images_height?p.scroller_images_height:"auto";
        ...
        function begin(){
            ...
            dom.children(".amazon_scroller_mask").width(u);
            dom.children(".amazon_scroller_mask").height(v);
            dom.find(".amazon_scroller_nav").css('top',(v-100)/2+parseInt(j)+"px");
            dom.find(".amazon_scroller_nav").width(u+212)
