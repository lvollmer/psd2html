...
(function($){
	...
	var defaultOptions = {
		...
		itemWidth: 350,				// width of one grid block in pixels;
		marginX: 20,				// width spacing between blocks in pixels;
        marginY: 20, 				// height spacing between blocks in pixels;
...
(function($){
	...
	var defaultOptions = {
		itemSelector: '> div',		// block identificator;
		itemWidth:200,				// width of one grid block in pixels;
		marginX: 20,				// width spacing between blocks in pixels;
        marginY: 20, 				// height spacing between blocks in pixels;
		align: 'left',			    // blocks alignment - 'left', 'right' or 'center';
		fitWidth: true,			    // adjusts block width to create optimal layout based on container size;
